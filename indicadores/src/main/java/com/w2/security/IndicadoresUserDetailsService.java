...
import com.w2.repository.auth.Grupos;
import com.w2.repository.auth.Permissoes;
import com.w2.repository.auth.Usuarios;


@Component
public class IndicadoresUserDetailsService implements UserDetailsService {
